                ...
                <div class="card-header d-flex align-items-center">
                    ...
                    <div class="btn-group gap-2 ">
                        <button class="btn btn-success btn-md rounded fw-bold text-white" type="button"
                            data-bs-toggle="modal" data-bs-target="#tambahOki">
                            <i class="fas fa-plus"></i>&nbsp;&nbsp;&nbsp;Tambah Data
                        </button>
                    </div>
                </div>
                <?php echo $__env->make('admin.senders.modal.tambah_oki', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <div class="card-body">
                    <table id="datatable" class="table dt-responsive  w-100">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $okis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                    ...
                                    <td class="align-middle p-2">
                                        <div class="btn-group gap-2">
                                            ...
                                            <?php echo $__env->make('admin.senders.modal.update_oki', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\STUDY\PROJECT\laragon\www\sistem_persuratan\resources\views/admin/senders/oki-management.blade.php ENDPATH**/ ?>