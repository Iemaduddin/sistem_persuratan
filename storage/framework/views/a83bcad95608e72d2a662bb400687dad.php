...
<?php $__env->startSection('content'); ?>
    ...
    <?php
        ...
        $no = 1;
        $sendersOki = Sender::where('scope', '=', 'OKI')->get();
        $sendersNaungan = Sender::where('scope', '=', 'Naungan')->get();
        $sendersOthers = Sender::where('scope', '=', 'Others')->get();
    ?>
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <table id="datatable" class="table dt-responsive  w-100">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $suratMasuk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <?php echo e($document->no_surat); ?>

                                    </td>
                                    <td>
                                        <?php echo e($document->sender->name); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\STUDY\PROJECT\laragon\www\sistem_persuratan\resources\views/document/surat/suratMasuk-management.blade.php ENDPATH**/ ?>