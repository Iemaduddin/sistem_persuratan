            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="datatable" class="table dt-responsive  w-100">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $proposalNaungan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <?php
                                            // Mengambil kata terakhir sebagai nama naungan
                                            $naunganCategory = str_word_count($document->category, 1);
                                            $naungan = end($naunganCategory);
                                        ?>
                                        <?php echo e($naungan); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\STUDY\PROJECT\laragon\www\sistem_persuratan\resources\views/document/proposal/proposalNaungan-management.blade.php ENDPATH**/ ?>