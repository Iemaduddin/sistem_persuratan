            ...
            <div class="row">
                <div class="col-xl-2 col-md-6">
                    ...
                    <div class="card card-h-100">
                        <!-- card body -->
                        <a href="{{ route('doc.suratMasuk') }}" class="card-body d-flex align-items-center">
                            <div class="flex-grow-1">
                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Surat Masuk</span>
                                <h4 class="mb-3">
                                    <span class="counter-value" data-target="{{ $suratMasukCount }}">0</span> Surat
                                </h4>
                            </div>
                ...
                <div class="col-xl-2 col-md-6">
                    <!-- card -->
                    <a href="{{ route('doc.suratKeluar') }}" class="card card-h-100">
                        <!-- card body -->
                        <div class="card-body d-flex align-items-center">
                            <div class="flex-grow-1">
                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Surat Keluar</span>
                                <h4 class="mb-3">
                                    <span class="counter-value" data-target="{{ $suratKeluarCount }}">0</span> Surat
                                </h4>
                            </div>
                ...
                <div class="col-xl-2 col-md-6">
                    <!-- card -->
                    <a href="{{ route('doc.proposalHmti') }}" class="card card-h-100">
                        <!-- card body -->
                        <div class="card-body d-flex align-items-center">
                            <div class="flex-grow-1">
                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Proposal HMTI</span>
                                <h4 class="mb-3">
                                    <span class="counter-value" data-target="{{ $proposalHmtiCount }}">0</span>
                                    Proposal
                                </h4>
                            </div>
                ...
                <div class="col-xl-2 col-md-6">
                    <!-- card -->
                    <a href="{{ route('doc.lpjHmti') }}" class="card card-h-100">
                        <!-- card body -->
                        <div class="card-body d-flex align-items-center">
                            <div class="flex-grow-1">
                                <span class="text-muted mb-3 lh-1 d-block text-truncate">LPJ HMTI</span>
                                <h4 class="mb-3">
                                    <span class="counter-value" data-target="{{ $lpjHmtiCount }}">0</span> LPJ
                                </h4>
                            </div>
                ...
                <div class="col-xl-2 col-md-6">
                    <!-- card -->
                    <a href="{{ route('doc.proposalNaungan') }}" class="card card-h-100">
                        <!-- card body -->
                        <div class="card-body d-flex align-items-center">
                            <div class="flex-grow-1">
                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Proposal Naungan</span>
                                <h4 class="mb-3">
                                    <span class="counter-value" data-target="{{ $proposalNaunganCount }}">0</span> Proposal
                                </h4>
                            </div>
                ...
                <div class="col-xl-2 col-md-6">
                    <!-- card -->
                    <a href="{{ route('doc.lpjNaungan') }}" class="card card-h-100">
                        <!-- card body -->
                        <div class="card-body d-flex align-items-center">
                            <div class="flex-grow-1">
                                <span class="text-muted mb-3 lh-1 d-block text-truncate">LPJ Naungan</span>
                                <h4 class="mb-3">
                                    <span class="counter-value" data-target="{{ $lpjNaunganCount }}">0</span> LPJ
                                </h4>
                            </div>
...
@section('script')
    ...
    <script src="{{ URL::asset('assets/js/pages/apexcharts.js') }}"></script>
    ...
    <script>
        ...
        function fetchData(selectedYear) {
            fetch("{{ route('getDataChart') }}?year=" + selectedYear)
