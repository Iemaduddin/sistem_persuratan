<div class="modal fade text-left" id="tambahLetter" tabindex="-1" role="dialog" aria-labelledby="modalTambahLetter"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modalTambahLetter">Tambah Data</h4>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <textarea type="text"rows="5" placeholder="Program Kerja" class="form-control" name="nama_kegiatan" required></textarea>
                            </div>
                        </div>
                        <div class="col-sm-6">
